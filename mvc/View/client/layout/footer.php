<section id="footer">
      <div class="container">
        <div class="row text-center text-xs-center text-sm-left text-md-left">
          ...
          <div class="col-xs-12 col-sm-4 col-md-4">
            <h5 id="footer-text">CÔNG TY THỦ CÔNG MỸ NGHỆ</h5>
            <ul class="list-unstyled quick-links">
              <li><i class="fa fa-angle-double-right"></i> Địa chỉ: Mỹ Đình - Nam Từ Liêm - Hà Nội</li>
              <li><i class="fa fa-angle-double-right"></i> Hotline: 0123 456 789</li>
              <li><i class="fa fa-angle-double-right"></i> Website: www.mynghehanoi.ml</li>
